...
export default function Lab1() {
  return (
    <div id="wd-lab1">
        <h1>Zhenze Mo - Section 04</h1>
        <h2>CS5610 - CRN 18616 2025 Fall</h2>
...
tag to tell browsers to render the gaps.
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                ...
                <li>Add noodles and cook for 3 minutes.</li>
                <li>Add seasoning packet and stir.</li>
                <li>Serve hot.</li>
            </ol>
        ...
        <div id="wd-forms">
            ...
            <form id="wd-text-fields">
                ...
                <a href="https://github.com/ZhenzeMo/cs5610_25fall_Kambaz" id="wd-github">My GitHub Repository</a>
